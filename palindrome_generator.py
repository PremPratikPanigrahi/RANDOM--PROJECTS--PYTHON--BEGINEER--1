...
import time
import sys
sys.set_int_max_str_digits()
print("This is the best python based palindrone checker and generator")


x=1
while x==1:
 Input=int(input("\nEnter\n1 if you want to generate a palindrone number\n2 if you want to check if  a given number is palindrone or not\n\n"))
 ...
 if Input ==1:
  y=1
  while y==1:
   k = random.randint(1,99999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999)  
